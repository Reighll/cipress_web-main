...
<div class="container mx-auto p-4">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12 max-w-md mx-auto w-full">
            ...
            <div class="space-y-4">
                <a href="/login/owner" class="block text-center w-full bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-3 px-4 rounded-lg">OWNER</a>
                <a href="/login/staff" class="block text-center w-full bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-3 px-4 rounded-lg">STAFF</a>
            </div>
            <div class="text-center mt-8"><a href="/register" class="text-gray-400 hover:text-white">CREATE ACCOUNT</a></div>
        </div>
    </div>
</div>
</body>
